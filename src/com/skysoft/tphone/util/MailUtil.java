...
public class MailUtil {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String mailActiveCode) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "TPHONE手机论坛社区", "UTF-8"));
        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "网站用户", "UTF-8"));
        message.setRecipient(MimeMessage.RecipientType.CC,new InternetAddress(myEmailAccount, "TPHONE账户安全团队", "UTF-8"));
        // 4. Subject: 邮件主题
        message.setSubject("账号安全风险提醒", "UTF-8");
        // 5. Content: 邮件正文（可以使用html标签）
        message.setContent("尊敬的用户：<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您好！您的账号于<h2>"+time+"</h2>进行找回密码操作。<br>您的账号密码为："+mailActiveCode+"</a>，此邮件涉及账号密码等敏感信息，建议阅后删除！(系统发送，请勿回复！)", "text/html;charset=UTF-8");
        // 6. 设置发件时间
